...
import { Button, Input, Card, CardContent, Divider } from '@/components/ui';
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 p-12 flex-col justify-between overflow-hidden">
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <p className="text-white/70 text-lg max-w-md">
                        Manage projects, track time, handle leaves, and collaborate with your team — all in one powerful platform.
                    </p>
                    <div className="flex items-center gap-6 pt-4">
                        <div className="flex items-center gap-2">
                            <div className="h-2 w-2 rounded-full bg-emerald-400" />
                            <span className="text-white/60 text-sm">Project Management</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="h-2 w-2 rounded-full bg-sky-400" />
                            <span className="text-white/60 text-sm">Time Tracking</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <div className="h-2 w-2 rounded-full bg-amber-400" />
                            <span className="text-white/60 text-sm">Team Chat</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center p-8 bg-slate-50 dark:bg-slate-950">
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500 dark:text-slate-400">Sign in to continue to your workspace</p>
                    </div>
